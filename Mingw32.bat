...
rem
rem GCC-2.95.2/Mingw32 build of Mesa 3-D Graphics Library (v3.2)
...
rem Return to mesa-3.2 'root' directory
cd %mesaroot%

rem Begin build of mesa-3.2 libs for GCC-2.95.2/Mingw32
