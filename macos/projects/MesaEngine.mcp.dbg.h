 ...
 */
#define GLI_OPENGL_ENGINE				1
/*
 * USE_OPENGL_MEMORY: Uses the OpenGL memory manager.
 */
#define USE_OPENGL_MEMORY				1
/*
 * MESA_3DFX_STANDALONE_GLI_PLUGIN: Compile as a GLI plugin.
 */
#define MESA_3DFX_STANDALONE_GLI_PLUGIN		1
/*
