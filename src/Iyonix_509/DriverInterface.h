...
typedef int sem_id, area_id, benaphore, status_t, display_timing, overlay_buffer, overlay_token, overlay_window, overlay_view, agp_info;
...
#define B_DEVICE_OP_CODES_END 0
